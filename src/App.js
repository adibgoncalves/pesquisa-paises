...
export default class App extends Component {
  ...
  async componentDidMount() {
    ...
    const filteredPopulation = this.calculateTotalPopulationForm(allCountries);
  ...
  calculateTotalPopulationForm = (countries) => {
  ...
  handleChangeFilter = (newText) => {
    ...
    const filteredPopulation = this.calculateTotalPopulationForm(filteredCountries);
